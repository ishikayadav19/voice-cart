        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <GradientText
              ...
              animationSpeed={4}
              className="text-4xl md:text-5xl font-serif font-light mb-2 tracking-wide"
            >
              New Arrivals
            </GradientText>
            <p className="text-lg opacity-90 font-light tracking-wide">Check out our latest collection</p>
          </div>
        </div>
      </div>
              ...
              getFilteredProducts().map((product) => (
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute top-2 left-2 bg-[#D4AF37] text-white px-2 py-1 rounded-md font-bold tracking-wider text-xs">
                      New
                    </div>
                  </div>
                  <div className="p-4">
                    ...
                    <div className="flex items-center mb-3">
                      {product.discountPrice ? (
                        ...
                        <span className="text-xl font-bold text-[#1A1A1A]">₹{product.price.toFixed(2)}</span>
                      )}
                    </div>
