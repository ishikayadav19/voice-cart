  ...
  useEffect(() => {
    const fetchSaleProducts = async () => {
      try {
        ...
        // Filter products with summer sale discounts (30-50% off)
        const saleProducts = response.data.filter(product => {
          ...
          return discountPercentage >= 30 && discountPercentage <= 50;
        });
      ...
      <div className="relative h-64 bg-gradient-to-r from-[#1A1A1A] to-[#D4AF37] mb-8 mt-16">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-lg opacity-90 font-light tracking-wide">Up to 50% off on selected items</p>
          </div>
        </div>
      </div>
