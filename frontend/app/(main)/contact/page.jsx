...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-[#FAF9F6] py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white border border-[#E5E0D8] rounded-xl shadow-lg overflow-hidden mb-12">
              <div className="grid md:grid-cols-5">
                {/* Contact Information */}
                <div className="md:col-span-2 bg-gradient-to-br from-[#1A1A1A] to-[#D4AF37] text-white p-8">
                  <SectionHeading
                    title="Get in Touch"
                ...
                <div className="md:col-span-3 p-8">
                  ...
                  {success && (
                    <div className="mb-6 p-4 bg-green-50 border border-green-100 text-green-700 rounded-md flex items-center text-sm">
                      <Check className="h-5 w-5 mr-2" />
                      <span>Your message has been sent successfully! We'll get back to you soon.</span>
                    </div>
                  )}

                  {error && <div className="mb-6 p-4 bg-red-50 border border-red-100 text-red-700 rounded-md text-sm">{error}</div>}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="block w-full px-4 py-3 border border-[#E5E0D8] rounded-md shadow-sm placeholder-[#7A7571] focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition-all duration-300"
                    ...
                    <div>
                      <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-md shadow-sm text-white bg-[#1A1A1A] hover:bg-[#D4AF37] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#D4AF37] tracking-wider transition-all duration-300 ${
            ...
            {/* FAQ Section */}
            <div className="mb-12">
              <h2 className="text-2xl font-serif font-light text-[#1A1A1A] mb-6 text-center">Frequently Asked Questions</h2>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-[#E5E0D8] p-6 rounded-lg shadow-md">
                  <h3 className="text-lg font-medium text-[#1A1A1A] mb-2">How do I track my order?</h3>
                ...
                <div className="bg-white border border-[#E5E0D8] p-6 rounded-lg shadow-md">
                  <h3 className="text-lg font-medium text-[#1A1A1A] mb-2">What is your return policy?</h3>
                  <p className="text-[#5C5C5C]">
                ...
                <div className="bg-white border border-[#E5E0D8] p-6 rounded-lg shadow-md">
                  <h3 className="text-lg font-medium text-[#1A1A1A] mb-2">How does voice shopping work?</h3>
                  <p className="text-[#5C5C5C]">
                ...
                <div className="bg-white border border-[#E5E0D8] p-6 rounded-lg shadow-md">
                  <h3 className="text-lg font-medium text-[#1A1A1A] mb-2">Do you ship internationally?</h3>
                  <p className="text-[#5C5C5C]">
            ...
            {/* Map */}
            <div className="bg-white border border-[#E5E0D8] rounded-xl shadow-lg overflow-hidden">
              <div className="p-6 border-b border-[#E5E0D8]">
                <h2 className="text-xl font-serif font-light text-[#1A1A1A]">Find Us</h2>
              </div>
              <div className="h-96 bg-[#FAF9F6]">
                {/* This would be replaced with an actual map component */}
                <div className="w-full h-full flex items-center justify-center">
                  <MapPin className="h-12 w-12 text-[#D4AF37] mr-2" />
                  <span className="text-lg font-medium text-[#5C5C5C]">Map would be displayed here</span>
                </div>
              </div>
            </div>
          </div>
